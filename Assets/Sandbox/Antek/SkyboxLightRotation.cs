...
public class SkyboxLightRotation : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        /*originalRotation.y = _directionalLight.transform.rotation.y;
        originalRotation.y += 360f;*/
    }
    void Update()
    {
        RenderSettings.skybox.SetFloat("_Rotation", Time.time * _rotationSpeed * 0.5f);

        /*_directionalLight.transform.DORotate(originalRotation, 1800f, RotateMode.WorldAxisAdd);
